...
<?php// установили выбор картинки в материале?>
    <div class="map_course">
    	...
    	<?php } ?>
        <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)); ?>" class="headline"><?php echo $article->title; ?><img class="right_arrow" src="images/right_arrow.png" alt=""></a>
        </div>

<?php// установили ПОЛЯ тегов на карте курсов?>
        <?php
        	$tags = '';
        	$file = '';
        	foreach($article->jcfields as $val){
        		if($val->title == 'Метки курса' && $val->rawvalue!= ''){
        			$tags = explode(",", $val->rawvalue);
        		}
        		if($val->title == 'Скачать программу курса' && $val->rawvalue!= ''){
        			$file = $val->rawvalue;
        		}
        	}
        ?>
...
<?php// установили счетчик тегов на карте курсов (в данном случае, должно быть видно 7 тегов, остальные скрываться)?>
        ...
        <div class="tags">
        	<ul>
        		...
        		<?php if($file != ''){ ?>
        			<li class="load" ><a href="/images/files/<?php echo trim($file); ?>"> ↓ Скачать полную программу курса</a></li>
        		<?php } ?>
...
<?php if($file != ''){ ?>
    <li><a href="/images/files/<?php echo trim($file); ?>">	↓ Скачать полную программу курса</a></li>
<?php }*/ ?>
