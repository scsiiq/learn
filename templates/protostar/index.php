...
// OWL
/*$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/owl/owl.carousel.min.css', $type = 'text/css', $media = 'screen,projection');
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/owl/owl.theme.default.min.css', $type = 'text/css', $media = 'screen,projection');
$doc->addScript ( $this->baseurl . '/templates/' . $this->template . '/js/owl/owl.carousel.min.js' );*/
...
<header>
    <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light rounded">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsBurger" aria-controls="navbarsBurger" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="container">
            <div class="row">
                    <div class="col-12 col-md-7">
                        ...
                        <a class="politic" href="/politika-obrabotki-personalnykh-dannykh">Политика обработки персональных данных</a>
                        <ul><li>2019 © <a href="https://web2.ru" target="_blank">Студия Web2</a> – Создание и продвижение сайтов</li></ul>
                    </div>
